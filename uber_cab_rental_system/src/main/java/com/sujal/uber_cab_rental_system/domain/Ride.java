...
public class Ride {
	...
	public Ride(UUID id, UUID riderId, VehicleType vehicleType, double pickupLatitude, double pickupLongitude,
			String pickupAddress, double dropoffLatitude, double dropoffLongitude, String dropoffAddress,
	...
	public void assignDriver(UUID driverId, String otp) {
